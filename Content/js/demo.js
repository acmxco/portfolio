 ...
 */
{
    ...
    class GridItem {
        constructor(el) {
            ...
            this.DOM.navtitle = this.DOM.el.querySelector(".codrops-links");
            // The rectangle element around the image.
        ...
        toggleTexts(delay, withAnimation, show = true) {
            TweenMax.to(
                [this.DOM.tilt.title, this.DOM.tilt.number], !withAnimation ? 0 : show ? 1 : 0.5, {
    ...
    // The frame class. Represents one content item per grid item.
    class Frame {
        constructor(el) {
            this.DOM = { el: el };
            // The content elements: image, title, subtitle and text.
            this.DOM.header = this.DOM.el.querySelector(".codrops-header");
        }
        ...
        openItem(item) {
            ...
            TweenMax.to(item.DOM.tilt.img, 1.2, {
                ...
                onComplete: () => {
                    ...
                    // this.DOM.grid.navtitle.add('title--hidden');
                    // Hiding the grid scroll.
